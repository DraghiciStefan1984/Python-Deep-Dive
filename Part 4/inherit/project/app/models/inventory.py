# -*- coding: utf-8 -*-
"""
Created on Fri Feb 14 11:27:24 2020
...
class Resource:
    def __init__(self, name, manufacturer, total, allocated):
        ...
        validate_integer('allocated', allocated, 0, total, custom_max_message='Allocated inventory cannot exceed total inventory')
    ...
    def freeup(self, num):
        validate_integer('num', num, 1, self.allocated, custom_max_message='Cannot return more than allocated')
        self._allocated -= num
